...
import commands
pynotify.init("Basic")
community = feedparser.parse(
    'https://www.archlinux.org/feeds/packages/x86_64/feed/')
core = feedparser.parse(
    'https://www.archlinux.org/feeds/packages/x86_64/core/')
extra = feedparser.parse(
    'https://www.archlinux.org/feeds/packages/x86_64/extra/')
multilib = feedparser.parse(
    'https://www.archlinux.org/feeds/packages/x86_64/multilib/')
...
for package in packages:
    ...
    if rpack in localpacname:
        remote, local = package[:package.rindex(" ")], localpac[
            localpacname.index(rpack)]
